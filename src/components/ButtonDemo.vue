<template>
  ...
  <section>
    <h1>示例5</h1>
    <section>
      <Button v-for="item in buttonSet5.sub1" :level="item.level" :theme="item.theme" loading >{{item.innerText}}</Button>
      <Button  >加载完毕</Button>
    </section>
  </section>

<!--以下为对照的代码，用于上面数据绑定参考-->
<!--  <section>Button 示例</section>-->
<!--  <h1>示例1</h1>-->
<!--  <section>-->
<!--    <Button>你好</Button>-->
...
export default {
  ...
  data() {
    return {
      ...
      buttonSet2: {
        sub1: [{size: 'big', innerText: '大大大'}, {size: '', innerText: '普通'}, {size: 'small', innerText: '小小小'},],
